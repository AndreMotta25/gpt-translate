...
class Icon {
    element;
    constructor() {
        const buttonGPT = document.createElement('button');
        buttonGPT.classList.add('gpt-translate-1542')
        buttonGPT.style.display = 'none';

        this.element = buttonGPT;
        ...
        document.body.appendChild(buttonGPT);
    }

    create({x,y}:IPositition) {
        if(this.element) {
